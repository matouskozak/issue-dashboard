...
|-----------|----------|----------|
| Python scripts, API integration, data pipeline | McManus 🔧 | fetch_issues.py, build_reports.py, scoring logic, JSON pipeline |
| HTML templates, CSS, JS, dashboard UI | Fenster ⚛️ | html_template.py, shared-styles.css, shared-ui.js, index.html |
| Architecture, scoring design, scope | Keaton 🏗️ | Data model decisions, scoring weights, component interfaces |
| Code review | Keaton 🏗️ | Review PRs, check quality, suggest improvements |
| Testing | Hockney 🧪 | Write tests, edge cases, scoring validation, CI verification |
| Scope & priorities | Keaton 🏗️ | What to build next, trade-offs, decisions |
| GitHub Actions workflow | McManus 🔧 | generate-reports.yml, CI setup |
